...
namespace Lucky.AssetManager.Tests.Assets.Fluent {
    [TestFixture]
    public class CssAssetBuilderTests {
        ...
        public void Constructor_ValidParams_ThrowsNoErrors() {
            var builder = new CssAssetBuilder(_context, _settings, "valid-path", _manager.Object, "group", true);
        ...
        public void Constructor_NullPath_ThrowsException() {
            new CssAssetBuilder(_context, _settings, null, _manager.Object, "group", true);
        }

        [Test]
        [ExpectedException(typeof(ArgumentException), ExpectedMessage = "path", MatchType = MessageMatch.Contains)]
        public void Constructor_EmptyPath_ThrowsException() {
            new CssAssetBuilder(_context, _settings, "", _manager.Object, "group", true);
        }
        ...
        public void Constructor_NullAssetManager_ThrowsException() {
            new CssAssetBuilder(_context, _settings, "valid-path", null, "group", true);
        }

        [Test]
        public void Constructor_AnyBoolean_SetsOnLayoutPage() {
            new CssAssetBuilder(_context, _settings, "valid-path", _manager.Object, "group", true).Add();
            Assert.That(_lastAddedAsset, Is.Not.Null);
            Assert.That(_lastAddedAsset.OnLayoutPage, Is.EqualTo(true));

            new CssAssetBuilder(_context, _settings, "valid-path", _manager.Object, "group", false).Add();
            Assert.That(_lastAddedAsset, Is.Not.Null);
        ...
        public void Add_ValidParams_AddsAsset() {
            ...
            Assert.That(_lastAddedAsset, Is.InstanceOf(typeof(CssAsset)));
            Assert.That(((CssAsset) _lastAddedAsset).Media, Is.EqualTo(Constants.DefaultCssMediaType));
        }
        ...
        public void Add_NoAssetGroup_DoesNotAddAssetGroup() {
            new CssAssetBuilder(_context, _settings, "valid-path", _manager.Object, null, true).Add();
        ...
        public void Remove_ValidParams_RemovesAsset() {
            new CssAssetBuilder(_context, _settings, "valid-path", _manager.Object, "group", true).Remove();
            Assert.That(_lastRemovedAsset, Is.Not.Null);
            Assert.That(_lastRemovedAsset.Path, Is.EqualTo("valid-path"));
            Assert.That(_lastRemovedAsset, Is.InstanceOf(typeof(CssAsset)));
            Assert.That(((CssAsset) _lastRemovedAsset).Media, Is.EqualTo(Constants.DefaultCssMediaType));
        }
        ...
        public void Remove_NoAssetGroup_DoesNotRemoveAssetGroup() {
            new CssAssetBuilder(_context, _settings, "valid-path", _manager.Object, null, true).Remove();
        ...
        public void WithAlternatePath_ValidParams_AddsAlternatePath() {
            new CssAssetBuilder(_context, _settings, "valid-path", _manager.Object, "group", true)
        ...
        [Test]
        public void ForMediaType_ValidParams_AddsMediaType() {
            new CssAssetBuilder(_context, _settings, "valid-path", _manager.Object, "group", true)
                .ForMediaType("mediaType")
                .Add();
            Assert.That(_lastAddedAsset, Is.Not.Null);
            Assert.That(_lastAddedAsset, Is.InstanceOf(typeof(CssAsset)));
            Assert.That(((CssAsset) _lastAddedAsset).Media, Is.EqualTo("mediaType"));
        }

        [Test]
        public void ForMediaType_NullType_DoesNotAddMediaType() {
            new CssAssetBuilder(_context, _settings, "valid-path", _manager.Object, "group", true)
                .ForMediaType(null)
                .Add();
            Assert.That(_lastAddedAsset, Is.Not.Null);
        ...
        [Test]
        public void ForMediaType_EmptyType_DoesNotAddMediaType() {
            new CssAssetBuilder(_context, _settings, "valid-path", _manager.Object, "group", true)
                .ForMediaType("")
                .Add();
            Assert.That(_lastAddedAsset, Is.Not.Null);
        ...
        [Test]
        public void ForMediaType_WhitespaceType_DoesNotAddMediaType() {
            new CssAssetBuilder(_context, _settings, "valid-path", _manager.Object, "group", true)
                .ForMediaType("   ")
                .Add();
            Assert.That(_lastAddedAsset, Is.Not.Null);
        ...
        [Test]
        public void ForMediaType_NotCalled_DoesNotAddNewMediaType() {
            new CssAssetBuilder(_context, _settings, "valid-path", _manager.Object, "group", true)
                .Add();
            Assert.That(_lastAddedAsset, Is.Not.Null);
            Assert.That(_lastAddedAsset, Is.InstanceOf(typeof(CssAsset)));
        ...
        [Test]
        public void ForMediaType_CalledMultipleTimes_AddsMediaTypeForOnlyLastCall() {
            new CssAssetBuilder(_context, _settings, "valid-path", _manager.Object, "group", true)
                .ForMediaType("mediaType")
                .ForMediaType("mediaType2")
                .ForMediaType("mediaType3")
                .Add();
            Assert.That(_lastAddedAsset, Is.Not.Null);
            Assert.That(_lastAddedAsset, Is.InstanceOf(typeof(CssAsset)));
            Assert.That(((CssAsset) _lastAddedAsset).Media, Is.EqualTo("mediaType3"));
            
        }

        #endregion ForMediaType
